...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <nav className="w-full bg-surface border-b border-border px-4 sm:px-6 py-4 flex items-center gap-2 sm:gap-4 shadow-lg transition-colors duration-300">
      {/* Logo and Title */}
      ...
      <input
        className="w-48 sm:w-64 bg-input border border-border rounded-lg px-3 sm:px-4 py-2 text-foreground placeholder-muted-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
        placeholder="Search..."
        value={search}
